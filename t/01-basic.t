...
class_api_ok( $class,
  qw( before new dsn username password dbh dir do_before tracking_table adjust_migrate quoted_tracking_table driver migrate version )
);

class_api_ok( $subclass, qw( new do_before managed_schema tracking_schema adjust_migrate quoted_tracking_table ) );
